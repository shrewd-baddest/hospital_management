...
import { patientDash } from "../Controllers/patient/dashboardConroller.js";
import { wardBedDescription, wardBeds } from "../Controllers/Nurse/BedController.js";
...
webpages.get("/patient/dashboard", verifyToken, patientDash);
webpages.get("/ward_beds", wardBeds);
webpages.get("/ward_beds/description",verifyToken, wardBedDescription);
