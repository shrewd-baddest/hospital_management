            ...
            <section className="mt-10">
              ...
              <div className="max-w-md">
                <p className="text-sm text-gray-500">
                  ...
                  status (stable, observation, critical, discharged). It helps
                  you quickly identify how many patients are in critical
                  condition and may require immediate attention.
                </p>
                <DoughnutChart />
              </div>
            </section>
