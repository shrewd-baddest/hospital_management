...
const Reports = () => {
  ...
  return (
    <>
      <h1 className="font-bold text-xl">Hospital Reports</h1>
      <p>
      ...
      <div className="flex md:flex-row flex-col gap-[5%] mt-4">
        <div className="grid grid-cols-1 gap-2">
          <div className="p-4 bg-white rounded shadow outline-2">
            ...
            <div className="flex flex-col">
              <button
                ...
                className="hover:rounded-md hover:bg-gray-200 flex flex-row px-4 py-1"
              >
                <PresentationChartLineIcon className="w-6 h-6 text-blue-500 " />
                <p className="font-semibold ml-2 mb-3">Admissions</p>
              </button>
              <button
              ...
              >
                ...
                <p className="font-semibold ml-2 mb-3">Billing</p>
              </button>
              <button
              ...
              >
                ...
                <p className="font-semibold ml-2 mb-3">Occupancy</p>
              </button>
              <button
              ...
              >
                ...
                <p className="font-semibold ml-2 mb-3">Staff Activity</p>
              </button>
            </div>
          </div>
          ...
          <div className="p-4 bg-white rounded shadow outline-2">
            <h2>Date Range</h2>
            <div>
              <section className="grid lg:grid-cols-2 gap-2 mb-4">
                <button
                  onClick={() => {
                    setDays(7);
                    setDateRange({});
              ...
              >
                <div>
                  <label htmlFor="startDate" className="inline">
                    Start Date:
                  </label>
                ...
                <div>
                  <label htmlFor="endDate" className="inline">
                    End Date:
                  </label>
          ...
          <div className="p-4 bg-white rounded shadow outline-2">
            <h2 className="font-bold">Export Report</h2>
            <section className="grid grid-column p-3 gap-3">
              <button
                className="rounded-md hover:bg-gray-200 border-solid border-2 font-semibold px-4 py-1 "
                onClick={generatePDF}
              >
                <p>Export as PDF</p>
              </button>

              <button className="rounded-md  hover:bg-gray-200 border-solid border-2  font-semibold px-4 py-1">
                <p>Export as CSV</p>
              </button>
            </section>
          </div>
